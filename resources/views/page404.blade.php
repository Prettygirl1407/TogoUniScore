        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown">Pas trouvé</h1>
        ...
        <div class="container text-center">
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    ...
                    <a class="btn btn-primary rounded-pill py-3 px-5" href="{{ route('index') }}">Retourner a l'accueil</a>
                </div>
            </div>
        </div>
    </div>
